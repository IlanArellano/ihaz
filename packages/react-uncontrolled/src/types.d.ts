...
): Methods<IComponent, IMethods> & UncontrolledComponentResult<P>;

export type UncontrolledComponent = <
  IComponent extends ComponentType<any>,
  IMethods extends FunctionalMethods = IComponent extends ComponentType<
    infer IProps
  >
    ? IProps extends FunctionalManagerMethods<infer M>
      ...
      : {}
    : {},
  P = IComponent extends ComponentType<infer IProps>
...
export interface ViewContextHook {
  register: () => void;
  unregister: () => void;
  showAsync: ShowFuncWithoutContext;
